...
\institute{Department of Computer Sciences,	University of Mascara, Algeria,  \mailsa \and
  Department of Computer Sciences and Technology, ESIT, International University of La Rioja (UNIR), Spain, \mailsb \and
  Department of Architecture and Computer Technology, University of Granada, Spain, \mailsc \and
  Department of Computer Science, ESI, University of C\'adiz, Spain, \mailsd
}
...
\begin{itemize}
	\item Front = Track[9]: front distance to the track border (angle 0º).  %Pablo: in PDF Track[9] seems a paper citation, change it to Track\_9 instead
...
{\scriptsize
        ...
        should be the quantities used for comparison. }
	{
		\begin{tabular}{|c||c|c|c|c||c|c|c|c|}
			\hline
	 &\multicolumn{8}{c||}{ with population size 20 ( EVO)}\\ %Pablo: Remove EVO and put a reference to it, instead
		\hline
