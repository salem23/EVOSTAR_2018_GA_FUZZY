...
obtaining a robust design for the TORCS controller. % This robustness
...
races. %Pablo: "in practice mode" instead "in practice" to clarify
%Done - JJ
...
of circuits. %Pablo: and in future could help...
% No need in the abstract - JJ
\end{abstract}
...
needs the creation real self-driving cars that can travel in everyday roads and streets or, for
...
Pérez et al. presented an evolutionary fuzzy approach for TORCS in \cite{PerezEvolvingFuzzy09}, where they applied EAs for improving fuzzy models to infer the acceleration and turning angle. However, the models were not so specialized as the proposed here, since their controller did not compute the target speed. %Pablo: computing the target speed is better? Then emphasize it

Onieva et al.,\cite{LFAG} presented a parametrized modular architecture with a fuzzy system and a GA in the design of fuzzy logic controllers for steering wheel management that can reproduce human driver behavior, but it did not take the target speed into account, unlike our previous controller \cite{evo17_blind} which computed the target speed and the steer with two fuzzy sub-controllers and whose membership functions parameters were defined by trial/error process. 
...
\section{The TORCS simulator} % Do we need this short section? Can't
...
\subsection{Fuzzy target speed sub-controller} % We might not need
                                % subsections in conference
...
This difficulty have led us to move towards the use of Genetic Algorithms  \cite{GAs_Goldberg89} because of their global exploration characteristic in a complex environment, as this problem plots. %Pablo: I've removed "(GAs)" as this acronym was presented previously
% Mohammed - ok
...
\section{Results} %Pablo: I would remove "Simulation", because it also included the run of the EA, that is not a simulation.
% Mohammed - ok 
	\label{sec:results}
...
comparing them for racing performance. We have considered the following bots in the
experiments, making 10 evolutionary runs for every one, with the configuration shown in Table \ref{tab:GA_config}: 
%	
\begin{itemize}
...
\begin{table}[ht]
        ...
        should be the quantities used for comparison. }
	{
		\begin{tabular}{|c||c|c|c|c||c|c|c|c|}
		 ...
		 Best &\textbf{29.44}& 29.44& 0&231&\textbf{39.7395} & 29.25& 0& 286\\
			...
			\hline
			Mean &33.8880 &30.7880 &3.10&227.43&   44.1370&  30.1420 &   2.70&267.3000\\ 
			St. Dev.&5.6153&1.1879&4.5814&32.5488&6.7349&0.7834 &5.8128  & 22.0356\\
			\hline
...
% Mohammed - ok, it's correct
 ...
 Wilcoxon rank sum non-parametric test \cite{garcia09} is used to reject or accept the null hypothesis of equality of medians of the values of the two fitness functions for the 10 runs. The obtained pvalue was $p =  0.0017$ and the  test statistic is $stats = -3.1371$, this results lead to the rejection of null hypothesis with a threshold $\alpha=0.01$ which allows us to conclude that the two samples sets are different.
 
 % Mohammed - Runs were deleted by JJ ,could we  cite runs that are not in the Table???
%  These  runs values are used to computing the test results, it worth put them 
  %Pablo: I rewrote the last phrase check if it is correct
...
fuzzy separately from the others in a 
real race against five standard controllers from each team integrated
with TORCS. Tables \ref{tab:gfc1real}, \ref{tab:gfc2real} and
\ref{tab:adreal} illustrate their performance in a 5 laps real
race.  % Which track? - JJ

\begin{table}[!ht]
		\centering
                \caption{Results of GFC1 in a real race (5 laps) in E-Track5}
                % Explain the "Race time" row - JJ
	\label{tab:gfc1real}
	\begin{tabular}{|p{2cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|}
...
\begin{table}[!ht]
	\centering
	\caption{Results of GFC1 in a real race (5 laps) in E-Road track}
	\label{tab:gfc1real2}
	\begin{tabular}{|p{2cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|}
		\hline \textbf{E-Road} & \textbf{GFC1}&\textbf{berwin 10} & \textbf{bt 3} &\textbf{damned 2} & \textbf{inferno 5} & \textbf{tita 10}  \\
		\hline \textbf{Ranking} & 5/6&4/6&1/6&6/6&2/6&3/6\\			
		\hline \textbf{Race Time}	&  05:40:12\newline +57:22&  05:40:12\newline+43:04& 05:40:12& 05:40:12\newline+1 lap& 05:40:12\newline+16:51& 05:40:12\newline+29:97\\	
		\hline \textbf{Best Time}& 1:18:09 &1:15:33&1:12:48&1:19:55&1:13:77&1:16:21\\	
		\hline \textbf{Max Speed}& 211&208&224&188&221&209\\
		\hline \textbf{Damage}& 433& 578 & 984&2530&1831&694\\	
		\hline 
	\end{tabular}
\end{table}
...
\begin{table}[!ht]
	\centering
	\caption{Results of GFC2 in a real race (5 laps)in E-Track5}
	\label{tab:gfc2real}
	\begin{tabular}{|p{2cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|}
...
\begin{table}[!ht]
	\centering
	\caption{Results of GFC2 in a real race (5 laps) in E-Road track}
	\label{tab:gfc2real2}
	\begin{tabular}{|p{2cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|}
...
\begin{table}[!ht]
		\centering
	\caption{Results of AD in a real race in E-Track5}
	\label{tab:adreal}
...
\begin{table}[!ht]
	\centering
	\caption{Results of AD in a real race in E-Road track}
	\label{tab:adreal2}
	\begin{tabular}{|p{2 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|p{1.5 cm}|}
		\hline \textbf{E-Road} & \textbf{AD} & \textbf{berwin 10} & \textbf{bt 3} &\textbf{damned 2} & \textbf{inferno 5} & \textbf{tita 10}  \\
		\hline \textbf{Ranking} & 6/6&5/6&1/6&3/6&2/6&4/6\\			
		\hline \textbf{Race Time}	& 05:44:08\newline+5laps&05:44:08\newline+1 lap&05:44:08&05:44:08\newline+35:27&05:44:08\newline+34:72&05:44:08\newline+1 lap \\	
		\hline \textbf{Best Time}& 00:00&1:19:31&1:13:55&1:15:42&1:17:94&1:16:39\\	
		\hline \textbf{Max Speed}& 120&206&190&179&210&197\\	
		\hline \textbf{Damage}& 15731&688&422&810&1842&288 \\	
		\hline 
	\end{tabular}
\end{table}
...
GFC2 makes a better time than GFC1; on the other hand,  both finished
the race without sustaining any damage; the winner {\tt bt 3} did get
damaged in the race against GFC2. 
