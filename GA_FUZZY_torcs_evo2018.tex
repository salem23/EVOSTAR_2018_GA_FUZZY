...
% Antonio - TODO: check if it is real-coded. Extend the description of the algorithm.
...
The proposed optimization approach aims to find the optimal parameters of the membership functions of the two sub-controllers \cite{evo17} (see Figure \ref{fig:ga}). 
