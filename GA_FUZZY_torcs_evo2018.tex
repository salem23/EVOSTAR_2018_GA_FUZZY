...
In this line, the authors presented previously an approach in which two specialized fuzzy controllers were combined to decide the car's steering angle and desired speed in every single point (or tick) during a race \cite{evo17_blind}.  
