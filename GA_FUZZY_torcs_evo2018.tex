...
%% Mohammed - It is mentioned three lines before, rewriting it here would not  redundant??  
...
comapring them for racing performance. We have considered the following bots in the
...
% Mohammed - it could be done but it needs more then 30 runs to apply nonparametric tests ( Wilcoxon or others, normality condition is not verified for the Data of the two controllers)
...
Finally, we have tested every fuzzy separately from the others in a
...
\ref{tab:adreal} illustrate their performance in a 5 laps real race.  
