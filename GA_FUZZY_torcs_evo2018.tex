...
%	\tocauthor{}
	...
	\begin{abstract}
          ...
          volution, we intend to improve a modular fuzzy agent
...
The evolved drivers were compared and  evaluated in practise and
realistic races, yielding very good results mainly in tracks that have
...
most used simulator in the field of autonomous driving [***,***,***]. 
...
Many kind of controllers have been used in this simulator, but one of the most efficient controllers so far are fuzzy-based ones, as they simulate in part the human
reasoning when driving. % More references here - JJ
...
that can reproduce human driver behaviour but it didn't take the
